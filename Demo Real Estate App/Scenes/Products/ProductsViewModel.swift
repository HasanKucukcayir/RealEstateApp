...
extension ProductsViewModel {
  ...
  func generateProductTableViewCellModel(from dataSource: ProductList) -> [ProductTableViewCellModel] {
    dataSource.map {
      ...
      return ProductTableViewCellModel(imageUrl: imageUrl, price: price, productName: address, promotion: numberOfBedroom, numberOfBathroom: numberOfBathroom, size: size, unitCount: distance, logo: nil)
    }
  }
